...
@endsection
@section('titlePage')
    {{ trans('sections_trans.subSections') }}
@endsection
                ...
                <div class="card-body">
                    <div class="text-right">
                        <button type="button" class="btn btn-info btn-lg" data-toggle="modal"
                            ...
                            {{ trans('sections_trans.addSubSection') }}</button>
                    </div>
                    <br>
                            ...
                            <table id="gradeTable" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ trans('sections_trans.parentSection') }}</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($subSections as $subSection)
                                        <tr>
                                            ...
                                            <td>{{ $i }}</td>
                                            <td>
                                                <img src="{{ $subSection->getFirstMediaUrl('images') }}" / width="120px">
                                            </td>
                                            <td>{{ $subSection->section_name }}</td>
                                            </td>
                                            <td>{{ $subSection->getParentsSection->section_name }}</td>
                                            <td>
                                                @if ($subSection->is_active === 'active')
                                                    <label
                                            ...
                                            <td>
                                                <a href="#" class="btn btn-outline-info btn-sm" data-toggle="modal"
                                                    data-target="#edit{{ $subSection->id }}">{{ trans('sections_trans.edit') }}</a>
                                                <a href="#" class="btn btn-outline-danger btn-sm" data-toggle="modal"
                                                    data-target="#delete{{ $subSection->id }}">{{ trans('sections_trans.delete') }}</a>
                                            </td>
                                        </tr>


                                        <!-- Edit section -->
                                        <div class="modal fade" id="edit{{ $subSection->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form action="{{ route('sub_sections.update', 'test') }}"
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    <input type="text" name="section_name_ar"
                                                                        class="form-control"
                                                                        value="{{ $subSection->getTranslation('section_name', 'ar') }}">
                                                                </div>

                                                                <div class="col">
                                                                    <input type="text" name="section_name_en"
                                                                        class="form-control"
                                                                        value="{{ $subSection->getTranslation('section_name', 'en') }}">
                                                                    <input id="id" type="hidden" name="id"
                                                                        class="form-control" value="{{ $subSection->id }}">
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                <label>{{ trans('sections_trans.parentSection') }}</label>
                                                                <select class="form-control select2" style="width: 100%;"
                                                                    name="parent_section">
                                                                    <option
                                                                        value="{{ $subSection->getParentsSection->id }}">
                                                                        {{ $subSection->getParentsSection->section_name }}
                                                                    </option>
                                        ...
                                        <!-- delete_modal_Grade -->
                                        <div class="modal fade" id="delete{{ $subSection->id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('sub_sections.destroy', 'test') }}"
                                                            method="post">
                                                            {{ method_field('Delete') }}
                                                            @csrf
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="{{ route('sub_sections.store') }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        <label>{{ trans('sections_trans.parentSection') }}</label>
                                        <select class="form-control select2" style="width: 100%;" name="parent_section">
